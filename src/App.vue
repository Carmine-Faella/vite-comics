...
<template>
  ...
  <main>
    ...
    <section class="cnt-choises">
      <div class="item-icon">
        <div v-for="(item,index) in choises" class="image-wrap" :key="index">
          <div class="img-wrapper"><img :src="getImagePath(item.image)" alt="Immmagine"></div>
  ...
  <footer>
    <TheFooter :links="option"></TheFooter>
  </footer>
